...
class Temporarily_Hidden_Content_Template {
	...
	public function render($mainFile, $regions = array()) {
		...
		return eval($this->compile($mainCode));
	}

	public function getSource($mainFile, $regions = array()) {
		ob_start();
		$this->render($mainFile, $regions);
